    ...
    <div class="modal" id="trailer">
      <div class="modal-dialog">
        <div class="modal-content">
          <a href="#" class="hanging-close" data-dismiss="modal" aria-hidden=
          "true">
...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id=
    ...
    <h2><a href="#"  onmouseout="pane.close()"   onmouseover="pane=
                window.open({movie_storyline}, \
                {movie_title},'width=300,height=300,nonononononotop=0,left=0');
                return false;">{movie_title}</a></h2>
